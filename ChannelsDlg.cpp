...
void CChannelsDlg::OnInitDialog()
{
	...
	AFX_MAPMESSAGE(IDC_MIX_1,BN_CLICKED,OnChangeMix);
	AFX_MAPMESSAGE(IDC_MIX_2,BN_CLICKED,OnChangeMix);
	AFX_MAPMESSAGE(IDC_MIX_3,BN_CLICKED,OnChangeMix);
	AFX_MAPMESSAGE(IDC_MIX_4,BN_CLICKED,OnChangeMix);
	AFX_MAPMESSAGE(IDC_MIX_5,BN_CLICKED,OnChangeMix);
	AFX_MAPMESSAGE(IDC_MIX_6,BN_CLICKED,OnChangeMix);
	AFX_MAPMESSAGE(IDC_VOLBOX_1,EN_UPDATE,OnChangeVol_1);
	AFX_MAPMESSAGE(IDC_VOLBOX_2,EN_UPDATE,OnChangeVol_2);
	AFX_MAPMESSAGE(IDC_VOLBOX_3,EN_UPDATE,OnChangeVol_3);
	AFX_MAPMESSAGE(IDC_VOLBOX_4,EN_UPDATE,OnChangeVol_4);
	AFX_MAPMESSAGE(IDC_VOLBOX_5,EN_UPDATE,OnChangeVol_5);
	AFX_MAPMESSAGE(IDC_VOLBOX_6,EN_UPDATE,OnChangeVol_6);
	AFX_MAPMESSAGE(IDC_PANBOX_1,EN_UPDATE,OnChangePan_1);
	AFX_MAPMESSAGE(IDC_PANBOX_2,EN_UPDATE,OnChangePan_2);
	AFX_MAPMESSAGE(IDC_PANBOX_3,EN_UPDATE,OnChangePan_3);
	AFX_MAPMESSAGE(IDC_PANBOX_4,EN_UPDATE,OnChangePan_4);
	AFX_MAPMESSAGE(IDC_PANBOX_5,EN_UPDATE,OnChangePan_5);
	AFX_MAPMESSAGE(IDC_PANBOX_6,EN_UPDATE,OnChangePan_6);
	AFX_MAPMESSAGE(IDC_INV_1,BN_CLICKED,OnChangeInv_1);
	AFX_MAPMESSAGE(IDC_INV_2,BN_CLICKED,OnChangeInv_2);
	AFX_MAPMESSAGE(IDC_INV_3,BN_CLICKED,OnChangeInv_3);
	AFX_MAPMESSAGE(IDC_INV_4,BN_CLICKED,OnChangeInv_4);
	AFX_MAPMESSAGE(IDC_INV_5,BN_CLICKED,OnChangeInv_5);
	AFX_MAPMESSAGE(IDC_INV_6,BN_CLICKED,OnChangeInv_6);
